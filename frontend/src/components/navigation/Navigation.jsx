            ...
            <div className="hidden lg:flex items-center gap-8 absolute left-1/2 -translate-x-1/2">
              {navItems.map((item) => (
                <Button
                  ...
                  className="relative tracking-wide text-sm text-muted-foreground hover:text-foreground transition-colors group p-0"
                >
                  {item.label}
                  <span
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-70 bg-card border-l border-border z-50 lg:hidden"
            >
